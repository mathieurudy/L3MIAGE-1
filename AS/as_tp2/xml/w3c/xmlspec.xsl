...
<!-- ====================================================================== -->
  ...
  <xsl:template match="*">
    ...
    <font color="red" xmlns="http://www.w3.org/1999/xhtml">
      <xsl:text>&lt;</xsl:text>
      <xsl:value-of select="name(.)"/>
      <xsl:text>&gt;</xsl:text>
      <xsl:apply-templates/>
  ...
  <xsl:template match="eg">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <table width="100%" cellpadding="5" border="1" bgcolor="#99ffff" xmlns="http://www.w3.org/1999/xhtml" class="eg" summary="Example">
          <tr>
            <td>
              <xsl:copy-of select="$content"/>
            </td>
  ...
  <xsl:template match="graphic">
    <img xmlns="http://www.w3.org/1999/xhtml" src="xmlspec_fichiers/source.html">
      <xsl:if test="@alt">
      ...
      <xsl:if test="not(/spec/@role='editors-copy')">
        <p>
          <a href="http://www.w3.org/">
            <img width="72" height="48" src="xmlspec_fichiers/w3c_home.png" alt="W3C"/>
          </a>
	  <xsl:choose>
	    <xsl:when test="/spec/@w3c-doctype='memsub'">
	      <a href="http://www.w3.org/Submission/">
		<img alt="Member Submission" src="xmlspec_fichiers/member_subm.png"/>
	      </a>
	    </xsl:when>
	    <xsl:when test="/spec/@w3c-doctype='teamsub'">
	      <a href="http://www.w3.org/2003/06/TeamSubmission">
		<img alt="Team Submission" src="xmlspec_fichiers/team_subm.png"/>
	      </a>
	    </xsl:when>
	  </xsl:choose>
        </p>
  ...
  <xsl:template match="latestloc">
	...
	<xsl:for-each select="loc">
	  ...
	  <dd xmlns="http://www.w3.org/1999/xhtml">
	    <a href="http://www.w3.org/TR/REC-xml/%7B@href%7D">
	      <xsl:value-of select="@href"/>
	    </a>
	  </dd>
	</xsl:for-each>
...
<!--
  ...
  <xsl:template match="errataloc">
    <p xmlns="http://www.w3.org/1999/xhtml">
      ...
      <a href="http://www.w3.org/TR/REC-xml/%7B@href%7D"><strong>errata</strong></a>
  ...
  <xsl:template match="preverrataloc">
    <p xmlns="http://www.w3.org/1999/xhtml">
      ...
      <a href="http://www.w3.org/TR/REC-xml/%7B@href%7D">previous errata</a>
      <xsl:text> for this document, are also available.</xsl:text>
    </p>
  </xsl:template>

  <xsl:template match="translationloc">
    <p xmlns="http://www.w3.org/1999/xhtml">See also <a href="http://www.w3.org/TR/REC-xml/%7B@href%7D"><strong>translations</strong></a>.</p>
  </xsl:template>
  ...
  <xsl:template match="titleref">
    <xsl:choose>
      ...
      <xsl:when test="ancestor::bibl/@href">
        <a xmlns="http://www.w3.org/1999/xhtml" href="http://www.w3.org/TR/REC-xml/%7Bancestor::bibl/@href%7D">
          <cite>
            <xsl:apply-templates/>
          </cite>
        </a>
